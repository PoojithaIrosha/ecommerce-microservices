...
import com.poojithairosha.common.notification.enums.EmailTemplates;
...
public class MailService {
    ...
    public void sendPaymentSuccessEmail(
        ...
        messageHelper.setFrom("info@ecom-ms.com");
        ...
        try {
            ...
            log.warn("Error sending payment confirmation email to: {}", destinationEmail);
        }
    }
    ...
    public void sendOrderConfirmationEmail(
        ...
        try {
            ...
            log.warn("Error sending order confirmation email to: {}", destinationEmail);
        }
